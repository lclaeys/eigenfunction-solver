...
Define the settings of the experiments, and initialize the NeuralSDE modules. 
Adapted from https://github.com/facebookresearch/SOC-matching.

Internal names: OU_quadratic_hard = Quadratic (REPULSIVE)
                OU_quadratic_stable = Quadratic (ISOTROPIC)
                OU_quadratic_anisotropic = Quadratic (ANISOTROPIC)
...
from SOC_eigf.models import LinearControl, LowDimControl
